...
public class OpenAlbumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_openAlbum = findViewById(R.id.OpenAlbum_button);
        imageView = findViewById(R.id.OpenAlbum_imgView);

        button_openAlbum.setOnClickListener(v -> openAlbum());
    }
